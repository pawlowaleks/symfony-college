 ...
 */
final class Version20210810085513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE major ADD CONSTRAINT FK_3D34FD0976FB3916 FOREIGN KEY (parent_major_id) REFERENCES major (id)');
        $this->addSql('CREATE INDEX IDX_3D34FD0976FB3916 ON major (parent_major_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE major DROP FOREIGN KEY FK_3D34FD0976FB3916');
        $this->addSql('DROP INDEX IDX_3D34FD0976FB3916 ON major');
